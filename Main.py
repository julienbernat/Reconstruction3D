...
if __name__ == "__main__":
    ...
    realTimeCapture(intrinsicL, intrinsicR, distL, distR, cameraMatrixL, cameraMatrixR, args.processing_unit)
    ...
    #(cropped, intrinsicL, cameraMatrixL, intrinsicR, cameraMatrixR, distL, distR, leftEyePixelsLEFT, rightEyePixelsLEFT, args.processing_unit)
    # end = time.time()
